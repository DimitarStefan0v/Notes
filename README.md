...
**_Note-taking app_** build with Node.js, Express and MongoDB. The app is using EJS as a templating engine. The data is stored in MongoDB using Mongoose as an Object Data Modeling for MongoDB. The app is using JWT authentication. Registered users are able to do CRUD operations on the notes they create. There is implemented paging on the /notes/all page if the user has more than 12 notes. The app has a responsive design build with pure css.
